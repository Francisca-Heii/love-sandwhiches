...
def update_worksheet(data, worksheet):
    ...
    Update the relevant woeksheet with data provided.
    '''
...
def get_last_5_entries_sales():
    ...
    last 5 entries for each sandwich and returns the data as a list
     of lists.
    ''' 
    sales = SHEET.worksheet('sales') #cerating a sales variable
...
def main():
    ...
    update_worksheet(sales_data, 'sales') #calling a function#
